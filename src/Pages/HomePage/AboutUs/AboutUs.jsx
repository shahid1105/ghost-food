import image from "../../../../public/image8.jpg";

const AboutUs = () => {
  return (
    <div className="bg-base-200 mt-36 rounded-2xl md:flex lg:flex md:justify-evenly lg:justify-evenly">
      <div className="md:w-1/2 lg:w-1/2">
        <h1 className="text-3xl md:text-5xl lg:text-5xl ms-10 font-bold md:ms-32 lg:ms-32  mt-16 pt-6">
          About Us
        </h1>
      ...
      <div className="md:w-1/2 lg:w-1/2">
        <img
          className="rounded-lg md:mb-44 mt-24 md:h-[400px] lg:h-[400px] md:w-[500px] lg:w-[500px]"
          src={image}
          alt=""
        />
      </div>
